...
public class CorruptedProceduralAPI extends Game {
    ...
    /**
     * Updates the countDown to show the remaining number of tiles that need to be matched to win the game.
     */
  ...
  */
   ...
   */
    ...
    /**
     * @Override Draws things in the correct order so they actually show up on the screen
     */
    ...
    /**
     *  flexible clear method
     * @param clearGrid whether to clear the grid
     * @param clearCounter whether to reset Counter
     * @param clearLaser whether to remove the laser
     */
     ...
     * Play a sound.
     *
     * @param file : sound file, must include the extension.
     */
